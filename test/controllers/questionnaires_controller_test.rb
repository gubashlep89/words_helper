...
class QuestionnairesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create questionnaire" do
    assert_difference('Questionnaire.count') do
      post questionnaires_url, params: { questionnaire: { description: @questionnaire.description, title: @questionnaire.title } }
    end
  ...
  test "should update questionnaire" do
    patch questionnaire_url(@questionnaire), params: { questionnaire: { description: @questionnaire.description, title: @questionnaire.title } }
