...
class StudentGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_group" do
    assert_difference('StudentGroup.count') do
      post student_groups_url, params: { student_group: { description: @student_group.description, name: @student_group.name, teacher_id: @student_group.teacher_id } }
    end
  ...
  test "should update student_group" do
    patch student_group_url(@student_group), params: { student_group: { description: @student_group.description, name: @student_group.name, teacher_id: @student_group.teacher_id } }
