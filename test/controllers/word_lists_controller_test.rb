...
class WordListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create word_list" do
    assert_difference('WordList.count') do
      post word_lists_url, params: { word_list: { name: @word_list.name, type: @word_list.type } }
    end
  ...
  test "should update word_list" do
    patch word_list_url(@word_list), params: { word_list: { name: @word_list.name, type: @word_list.type } }
